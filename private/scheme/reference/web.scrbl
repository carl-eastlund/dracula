...
@(require scribble/manual
          ...
          "../scribble.ss"
          "eval.ss")
@(require (for-label scheme xml (this-package-in scheme)))

@title[#:style 'quiet #:tag "web"]{XML and CSS}

@defmodule/this-package[web]
...
Here, @scheme[text] is any of the @secref{text} described above.
}
