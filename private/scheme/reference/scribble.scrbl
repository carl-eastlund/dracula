...
@(require scribble/manual
          ...
          scribble/bnf
          "../scribble.ss"
          (for-label scheme/base scribble/manual (this-package-in scheme)))

@title[#:tag "scribble"]{Scribble Documentation}
...
@schememodname/this-package[planet], @scheme[this-package-in] from
@schememodname/this-package[require-provide], and
@scheme[make-scribble-evaluator] and @scheme[make-scribble-module-evaluator]
from @schememodname/this-package[sandbox].
