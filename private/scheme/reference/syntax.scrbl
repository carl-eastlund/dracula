...
@title[#:style 'quiet #:tag "syntax"]{Syntax Objects}

@defmodule/this-package[syntax]
...
@defform[(with-syntax* ([pattern expr] ...) body ...+)]{

Like @scheme[with-syntax], but with nested scope.
